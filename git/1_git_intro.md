...
**Bash** - это одна из самых популярных и мощных командных оболочек, используемых в операционных системах семейства Unix, особенно в Linux. Используется для взаимодействия с компьютером через набор вводимых команд.
